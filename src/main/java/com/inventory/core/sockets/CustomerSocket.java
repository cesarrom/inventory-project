...
public class CustomerSocket extends IAMSocket<CustomerDto, CustomerQuery, CustomerBusiness> {
	...
	@MessageMapping("/customers/find-customer/{id}")
	@SendToUser("/queue/customers/customer-found")
	...
	@Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = { RuntimeException.class })
	@MessageMapping("/customers/list-customers")
	@SendToUser("/queue/customers/customers-listed")
	...
	@Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = { RuntimeException.class })
	@MessageMapping("/customers/create-customer")
	...
	@Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = { RuntimeException.class })
	@MessageMapping("/customers/update-customer/{id}")
	@SendTo("/topic/customers/customer-updated")
