...
public class MovementDetailSocket extends IAMSocket<MovementDetailDto, MovementDetailQuery, MovementDetailBusiness> {
	...
	@MessageMapping("/movement-details/find-movement-detail")
	...
	@Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = { RuntimeException.class })
	@MessageMapping("/movement-details/list-movement-details")
	...
	@Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = { RuntimeException.class })
	@MessageMapping("/movement-details/create-movement-detail")
	...
	@Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = { RuntimeException.class })
	@MessageMapping("/movement-details/update-movement-detail")
	@SendTo("/topic/movement-details/movement-detail-updated")
