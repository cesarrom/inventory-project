...
public class SupplierSocket extends IAMSocket<SupplierDto, SupplierQuery, SupplierBusiness> {
	...
	@MessageMapping("/find-supplier")
	@SendToUser("/queue/supplier-found")
	...
	@Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = { RuntimeException.class })
	@MessageMapping("/list-suppliers")
	@SendToUser("/queue/suppliers-listed")
	...
	@Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = { RuntimeException.class })
	@MessageMapping("/create-supplier")
	@SendTo("/topic/supplier-created")
	...
	@Transactional(propagation = Propagation.REQUIRES_NEW, rollbackFor = { RuntimeException.class })
	@MessageMapping("/update-supplier/{id}")
	@SendTo("/topic/supplier-updated")
